...
exports.runServer = exports.createServer = void 0;
...
function createServer(port = DEFAULT_PORT, config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let routes = yield runtime_paths_1.getFunctionsAndAssets(config.baseDir, searchConfig);
        ...
        if (config.live) {
            ...
            const reloadRoutes = () => __awaiter(this, void 0, void 0, function* () {
                routes = yield runtime_paths_1.getFunctionsAndAssets(config.baseDir, searchConfig);
