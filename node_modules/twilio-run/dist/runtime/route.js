...
exports.functionToRoute = exports.handleSuccess = exports.isTwiml = exports.handleError = exports.constructGlobalScope = exports.constructContext = exports.constructEvent = void 0;
...
const debug = logger_1.getDebugFunction('twilio-run:route');
...
function constructContext({ url, env }, functionPath) {
    function getTwilioClient() {
        ...
        return twilio_1.default(env.ACCOUNT_SID, env.AUTH_TOKEN);
    }
...
function constructGlobalScope(config) {
    ...
    if (check_account_sid_1.checkForValidAccountSid(config.env.ACCOUNT_SID) &&
        ...
        global['twilioClient'] = twilio_1.default(config.env.ACCOUNT_SID, config.env.AUTH_TOKEN);
    }
}
