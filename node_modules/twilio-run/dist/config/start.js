...
const debug = logger_1.getDebugFunction('twilio-run:cli:config');
function getUrl(cli, port) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (typeof cli.ngrok !== 'undefined') {
            ...
            url = yield require('ngrok').connect(ngrokConfig);
...
function getEnvironment(cli, baseDir) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fullEnvPath = path_1.resolve(baseDir || process.cwd(), envFilePath);
        if (yield fs_2.fileExists(fullEnvPath)) {
            try {
                debug(`Read .env file at "%s"`, fullEnvPath);
                const envContent = fs_1.readFileSync(fullEnvPath, 'utf8');
...
function getConfigFromCli(flags, cliInfo = { options: {} }, externalCliOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        const configFlags = global_1.readSpecializedConfig(flags.cwd || process.cwd(), flags.config, 'startConfig', {
            projectId: (externalCliOptions && externalCliOptions.accountSid) || undefined,
        });
        const cli = mergeFlagsAndConfig_1.mergeFlagsAndConfig(configFlags, flags, cliInfo);
        const config = {};
        ...
        config.url = yield getUrl(cli, config.port);
