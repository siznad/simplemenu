...
exports.cliInfo = {
    options: Object.assign(Object.assign(Object.assign({}, shared_1.sharedCliOptions), shared_1.sharedApiRelatedCliOptions), { cwd: {
            type: 'string',
            ...
            type: 'string',
            describe: 'Path to .env file. If none, the local .env in the current working directory is used.',
        }, 'override-existing-project': {
            type: 'boolean',
